    ...
    <div style="position:relative;background:var(--card-bg);border-radius:14px;box-shadow:0 20px 60px rgba(0,0,0,.25);width:100%;max-width:440px;margin:16px;">
        <div class="og-modal-header">
            <div style="display:flex;align-items:center;gap:10px;">
                <div class="og-modal-icon"><i class="fas fa-user-shield"></i></div>
                <h5 style="margin:0;">Nuevo Rol</h5>
            </div>
            <button class="og-modal-close" onclick="document.getElementById('modalRol').style.display='none'"><i class="fas fa-times"></i></button>
        </div>
